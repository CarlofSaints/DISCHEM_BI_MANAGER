  ...
  await getResend().emails.send({
    ...
    html: `
      <div style="font-family:Arial,sans-serif;max-width:520px;margin:0 auto">
        <div style="background:#FC5424;padding:24px 32px;border-radius:8px 8px 0 0">
        ...
        <div style="background:#fff;padding:32px;border:1px solid #e5e7eb;border-radius:0 0 8px 8px">
          ...
          <table style="background:#f9fafb;border:1px solid #e5e7eb;border-radius:6px;padding:16px;width:100%;margin-bottom:24px">
            <tr><td style="color:#6b7280;font-size:13px;padding-bottom:8px">Login URL</td><td style="color:#111827;font-size:13px;padding-bottom:8px"><a href="${APP_URL}" style="color:#FC5424">${APP_URL}</a></td></tr>
          ...
          <a href="${APP_URL}/login" style="display:inline-block;background:#FC5424;color:#fff;padding:12px 24px;border-radius:6px;text-decoration:none;font-weight:600;font-size:14px">Log In Now →</a>
